...
public class Comanda {
     ...
     */
    public Comanda(String id, String nombreCliente, Empleado empleado, Mesa mesa,
                   LocalDateTime fecha, float montoTotal, EstadoComanda estado,
                   List<Pedido> pedidos, List<Pago> pagos) {
        this.id = id;
