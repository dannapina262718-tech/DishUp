...
public class ComandaEntidadMongo {
     ...
     */
    public ComandaEntidadMongo(String id, String nombreCliente, String nombreEmpleado,
                               Integer numeroMesa, LocalDateTime fecha,
                               float montoTotal, EstadoComanda estado,
                               List<PedidoEntidadMongo> pedidos,
                               List<PagoEntidadMongo> pagos) {
        this.id = id;
