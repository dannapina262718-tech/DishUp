...
public class DlgDetallePedido extends JDialog {
    ...
    public DlgDetallePedido(java.awt.Frame parent, boolean modal, ComandaDTO comanda, PedidoDTO pedido, CoordinadorInterfaces coordinador) {
        super(parent, modal);
        ...
        if (pedido.getEstado() == EstadoPedidoDTO.PENDIENTE) {
            ...
            btnEditar.setPreferredSize(new Dimension(130, 42));
            ...
            btnEditar.addMouseListener(new java.awt.event.MouseAdapter() {
                ...
                public void mouseEntered(java.awt.event.MouseEvent e) {
                    btnEditar.setBackground(Color.decode("#FF9A52"));
                }
            ...
            btnEditar.addActionListener(e -> {
                coordinador.editarPedido(comanda, pedido);
                dispose();
            });
            ...
            btnCancelar.addMouseListener(new java.awt.event.MouseAdapter() {
                @Override
                public void mouseEntered(java.awt.event.MouseEvent e) {
                    btnCancelar.setBackground(Color.decode("#FF7B7B"));
                }
            ...
            btnCancelar.addActionListener(e -> {
                ...
                if (confirmacion == JOptionPane.YES_OPTION) {
                    ...
                    coordinador.cancelarPedido(comanda, pedido);
